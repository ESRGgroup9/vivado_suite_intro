...
################################################################
# This is a generated script based on design: fulladder_bd
#
...
# source fulladder_bd_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ia [ create_bd_port -dir I -from 0 -to 0 ia ]
  set ib [ create_bd_port -dir I -from 0 -to 0 ib ]
  set icin [ create_bd_port -dir I icin ]
  set ocout [ create_bd_port -dir O ocout ]
  set osum [ create_bd_port -dir O -from 0 -to 0 osum ]

  # Create instance: fulladder_ip_0, and set properties
  set fulladder_ip_0 [ create_bd_cell -type ip -vlnv user.org:user:fulladder_ip:1.0 fulladder_ip_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins fulladder_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net fulladder_ip_0_ofulladder_sum [get_bd_ports osum] [get_bd_pins fulladder_ip_0/ofulladder_sum]
  connect_bd_net -net fulladder_ip_0_ofulladder_wcout [get_bd_ports ocout] [get_bd_pins fulladder_ip_0/ofulladder_cout]
  connect_bd_net -net ia_0_1 [get_bd_ports ia] [get_bd_pins fulladder_ip_0/ia]
  connect_bd_net -net ib_0_1 [get_bd_ports ib] [get_bd_pins fulladder_ip_0/ib]
  connect_bd_net -net icin_0_1 [get_bd_ports icin] [get_bd_pins fulladder_ip_0/icin]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins fulladder_ip_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins fulladder_ip_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fulladder_ip_0/S00_AXI/S00_AXI_reg] -force
